...
import 'package:markiz_elamal_team_12/features/pyment_methods_feature/pyment_method_view.dart';
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      const Text(
                        ...
                        style: TextStyle(color: kLogoutTextColor, fontSize: 15),
                      ),
                      const SizedBox(
                        height: 20,
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.push(context,MaterialPageRoute(builder: (context) => MassageDoctorView(),));
                              },
                              child: const Text(
                                'Send Message',
                                style: TextStyle(
